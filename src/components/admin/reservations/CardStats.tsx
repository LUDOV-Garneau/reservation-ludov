...
interface CardReservationStatsProps {
...
export default function CardReservationStats({
  ...
  pastReservations,
  loading = false,
}: CardReservationStatsProps) {
  const isLoading =
    loading ||
    totalReservations === undefined ||
    futureReservations === undefined ||
    pastReservations === undefined;
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-3 sm:gap-4 mb-4 sm:mb-6">
      ...
      />
      <Stat
        label={t("admin.reservations.stats.upcomingReservations")}
        value={futureReservations}
        accent="green"
      />
      <Stat
        label={t("admin.reservations.stats.pastReservations")}
