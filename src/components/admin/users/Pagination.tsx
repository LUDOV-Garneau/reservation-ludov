          ...
          {totalItems > 0 ? (
            <>
              <span className="hidden sm:inline">
                {t("admin.users.pagination.affichageDe")} <span className="font-medium text-foreground">{startItem}</span> {t("admin.users.pagination.a")}{" "}
                <span className="font-medium text-foreground">{endItem}</span> {t("admin.users.pagination.sur")}{" "}
                <span className="font-medium text-foreground">{totalItems}</span>
              </span>
              <span className="sm:hidden">
                {startItem}-{endItem} {t("admin.users.pagination.sur")} {totalItems}
              </span>
            </>
          ) : (
