  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        range_start: cn(
          "rounded-l-md bg-cyan-500",
          defaultClassNames.range_start
        ),
        range_middle: cn("rounded-none", defaultClassNames.range_middle),
        range_end: cn("rounded-r-md bg-cyan-500", defaultClassNames.range_end),
        today: cn(
          "bg-cyan-500/10 text-cyan-900 border-cyan-500 border-1 rounded-md data-[selected=true]:rounded-md data-[selected=true]:bg-cyan-500",
...
function CalendarDayButton({
  ...
  return (
    <Button
      ...
      className={cn(
        "data-[selected-single=true]:bg-cyan-500",
        "data-[selected-single=true]:text-white",
        "data-[range-middle=true]:bg-cyan-300/20",
