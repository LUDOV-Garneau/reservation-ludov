...
export default function AccueilReservationCard({
  ...
  return (
    <Card className="w-full max-w-sm bg-[white] border-gray-200 overflow-hidden group h-full hover:scale-105 hover:border-cyan-500 transition-all duration-500 shadow-xl">
      <CardContent className="py-5 flex flex-col h-full">
        ...
        <div className="flex-grow mb-4">
          <p className="text-xs
           text-gray-500 tracking-wide font-medium mb-2">
